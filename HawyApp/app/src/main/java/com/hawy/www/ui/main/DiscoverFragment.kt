...
import com.hawy.www.databinding.FragmentDiscoverBinding
...
//        val repository = requireNotNull(this.sessionViewModel) {
//            "You can only access the viewModel after onActivityCreated()"
//        }
//        ViewModelProvider(this, SessionViewModel.Factory(repository.repository))
...
//        Log.d("TAG", "onCreate Sessions: ${sessionList.size}")
    }
